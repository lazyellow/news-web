    ...
    <el-row type="flex" justify="center">
      <el-col :span="16">
        <el-menu :default-active="$route.path" class="el-menu-demo" mode="horizontal" router>
          ...
          <el-menu-item index="/Hotnews">热点新闻</el-menu-item>
          ...
          <el-menu-item index="/Dynamic">{{CategoryList[3].category_name}}</el-menu-item>
          <!-- <el-submenu index="6">
          ...
          <!-- <el-menu-item index="/People">{{CategoryList[4].category_name}}</el-menu-item> -->
        </el-menu>
      </el-col>

      <el-col class="search" :span="5">
        <div>
          <el-input class="input-with-select" placeholder="请输入内容" v-model="searchValue">
...
export default {
  ...
  created: function() {
    this.$http
      .get("http://47.101.150.127:3030/category/getCategorys")
      .then(res => {

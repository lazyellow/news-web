<template>
    <div class="news">
            ...
            <el-row type="flex" justify="center">
                <el-col :span="18">
                    <div class="title-text">
                        {{CampusList[0].Category.category_name}}
                    </div>
                </el-col>
            </el-row>
        </div>
        ...
        <div class="news-list"  @click="getNewsDetail(item.news_id)"
            v-for="item in CampusList.slice((currentPage-1)*pagesize,currentPage*pagesize)" :key="item.news_id">
            <el-row type="flex" justify="center">
...
export default {
    ...
    created:function(){
        this.$http.get(`http://47.101.150.127:3030/news/getNewsByType?category_id=${2}`)
        .then(res => {
